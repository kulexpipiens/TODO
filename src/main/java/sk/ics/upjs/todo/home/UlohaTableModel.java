...
public class UlohaTableModel extends AbstractTableModel {
    ...
    private static final String[] NAZVY_STLPCOV = {"Zoznam úloh", "Ostáva"};
    ...
    //metóda vráti buď názov úlohy, alebo dátum, ktorý zostáva na jej vykonanie, podľa toho, v ktorom stĺpci sme
    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (columnIndex == 0) {
            ...
            //oifované prípady, aby zobrazovalo iba 2 najväčšie časové obdobia, napr. rok a mesiace, mesiace a týždne, hodiny a minúty...
            if (rozdiel > rokMs) {
                pocet = (rozdiel / rokMs);
    ...
    //vyvpíše iba úlohy, ktoré zodpovedajú filtru
